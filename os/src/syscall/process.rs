...
use crate::{
    ...
    syscall::SYSCALL_COUNTER,
    task::{
        current_task_first_scheduled_time, exit_current_and_run_next, suspend_current_and_run_next,
        TaskStatus,
    },
    timer::get_time_us,
};
...
pub fn sys_task_info(_ti: *mut TaskInfo) -> isize {
    ...
    let syscall_times = syscall_counter.clone();
